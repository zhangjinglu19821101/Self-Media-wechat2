...
/**
 * 行业关键词映射表（与 materials/route.ts 保持一致，键必须与数据库 industry 枚举值一致）
 */
const INDUSTRY_KEYWORD_MAP: Record<string, { label: string; keywords: string[] }> = {
  insurance_property: { label: '车险/财产险', keywords: ['车险', '交强险', '商业车险', '车损险', '三者险', '盗抢险', '车上人员', '涉水险', '自燃险', '玻璃险', '不计免赔', '新车险', '车险理赔', '车险报价', '车保', '机动车', '新能源车险', '电动车险', '家财险', '财产险', '责任险', '雇主责任', '工程险'] },
  insurance_health: { label: '健康险/意外险', keywords: ['百万医疗', '医疗险', '重疾', '重疾险', '健康险', '住院医疗', '门诊险', '防癌险', '抗癌', '特药险', '惠民保', '免赔额', '续保', '保证续保', '等待期', '既往症', '健康告知', '核保', '意外险', '意外伤害', '意外医疗', '交通意外', '综合意外', '猝死', '意外身故', '意外伤残', 'DRG'] },
  insurance_life: { label: '人寿险/年金', keywords: ['寿险', '定期寿险', '终身寿险', '增额终身寿', '分红险', '万能险', '投连险', '年金', '养老年金', '教育金', '身故', '受益人', '保额', '现金价值', '退保', '港险', '香港保险', '传承', '信托', '遗嘱', '理赔', '投保', '少儿', '社保', '养老保险', '公积金', '五险一金', '退休金', '养老金'] },
  finance: { label: '金融理财', keywords: ['理财', '利率', '收益', '存款', '降息', '加息', '银行', '储蓄', '投资', '基金', '股票'] },
};
