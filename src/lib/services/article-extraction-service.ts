...
5. 每个素材必须包含：【素材内容】+【功能标签】+【前文】+【后文】+【情绪标签】+【与前文关系】六个部分
6. 【情绪标签】必须从以下6种中选择：共情/理性/警示/温情/专业/中性
7. 【与前文关系】描述此素材与文章中前一个素材的逻辑关系，如"承接前文引出新观点"、"转折反驳前文"、"并列补充前文"、"递进深化前文"、"总结收束前文"、"独立插入"
  ...
  "错误认知": [
    {
      ...
      "前文": "这个素材前面紧挨着的原文内容",
      "后文": "这个素材后面紧挨着的原文内容",
      "情绪标签": "共情/理性/警示/温情/专业/中性（六选一）",
      "与前文关系": "描述此素材与文章中前一个素材的逻辑关系"
    }
  ],
  "生活类比": [
    {
      ...
      for (const item of items) {
        ...
        if (typeof item === 'object' && item !== null) {
          ...
          relationalMaterials.push({
            ...
            emotion: String(m['情绪标签'] || m.emotion || ''),
            relationToPrevious: String(m['与前文关系'] || m.relationToPrevious || ''),
