...
export const PARADIGM_SEED_DATA = [
  ...
  // ============================================================
  {
    ...
    materialPositionMap: [
      // 7维度标准映射：01=misconception, 02=analogy, 03=data, 04=case, 05=golden_sentence, 06=fixed_phrase, 07=personal_fragment
      // 每个slot的materialTypes首元素为该位置的标准7维度类型，后续为语义适配类型
      { slotId: 'P001-01', paragraphOrder: 1, stepName: '错误认知', materialTypes: ['misconception', 'personal_fragment', 'case'], isPrimary: true, isOptional: false },
      { slotId: 'P001-02', paragraphOrder: 2, stepName: '共情接纳', materialTypes: ['analogy', 'misconception'], isPrimary: true, isOptional: false },
      { slotId: 'P001-03', paragraphOrder: 3, stepName: '点破错位', materialTypes: ['data', 'case'], isPrimary: true, isOptional: false },
      { slotId: 'P001-04', paragraphOrder: 4, stepName: '通俗类比', materialTypes: ['case', 'analogy', 'data'], isPrimary: true, isOptional: false },
      { slotId: 'P001-05', paragraphOrder: 5, stepName: '真实案例', materialTypes: ['golden_sentence', 'fixed_phrase', 'case'], isPrimary: true, isOptional: false },
      { slotId: 'P001-06', paragraphOrder: 6, stepName: '反问升华', materialTypes: ['fixed_phrase', 'golden_sentence'], isPrimary: true, isOptional: false },
      { slotId: 'P001-07', paragraphOrder: 7, stepName: '价值重构', materialTypes: ['personal_fragment', 'analogy'], isPrimary: true, isOptional: false },
  ...
  // ============================================================
  {
    ...
    materialPositionMap: [
      { slotId: 'P002-01', paragraphOrder: 1, stepName: '行业问题', materialTypes: ['misconception', 'case', 'data'], isPrimary: true, isOptional: false },
      { slotId: 'P002-02', paragraphOrder: 2, stepName: '承认不足', materialTypes: ['analogy', 'fixed_phrase'], isPrimary: true, isOptional: false },
      { slotId: 'P002-03', paragraphOrder: 3, stepName: '区分工具与人', materialTypes: ['data', 'analogy'], isPrimary: true, isOptional: false },
      { slotId: 'P002-04', paragraphOrder: 4, stepName: '分析根源', materialTypes: ['case', 'data', 'golden_sentence'], isPrimary: true, isOptional: false },
      { slotId: 'P002-05', paragraphOrder: 5, stepName: '改进方向', materialTypes: ['golden_sentence', 'data', 'case'], isPrimary: true, isOptional: false },
      ...
      { slotId: 'P002-07', paragraphOrder: 7, stepName: '收尾升华', materialTypes: ['personal_fragment', 'golden_sentence'], isPrimary: true, isOptional: false },
    ],
    emotionCurve: [
  ...
  // ============================================================
  {
    ...
    materialPositionMap: [
      { slotId: 'P003-01', paragraphOrder: 1, stepName: '案例引入', materialTypes: ['misconception', 'case'], isPrimary: true, isOptional: false },
      { slotId: 'P003-02', paragraphOrder: 2, stepName: '拆解过程', materialTypes: ['analogy', 'data', 'fixed_phrase'], isPrimary: true, isOptional: false },
      { slotId: 'P003-03', paragraphOrder: 3, stepName: '归谬分析', materialTypes: ['data', 'misconception'], isPrimary: true, isOptional: false },
      { slotId: 'P003-04', paragraphOrder: 4, stepName: '正确方案', materialTypes: ['case', 'fixed_phrase', 'data'], isPrimary: true, isOptional: false },
      ...
      { slotId: 'P003-07', paragraphOrder: 7, stepName: '金句收尾', materialTypes: ['personal_fragment', 'golden_sentence'], isPrimary: true, isOptional: false },
    ],
    emotionCurve: [
  ...
  // ============================================================
  {
    ...
    materialPositionMap: [
      { slotId: 'P004-01', paragraphOrder: 1, stepName: '本质定义', materialTypes: ['misconception', 'golden_sentence', 'fixed_phrase'], isPrimary: true, isOptional: false },
      { slotId: 'P004-02', paragraphOrder: 2, stepName: '通俗类比', materialTypes: ['analogy'], isPrimary: true, isOptional: false },
      { slotId: 'P004-03', paragraphOrder: 3, stepName: '常见误区', materialTypes: ['data', 'misconception'], isPrimary: true, isOptional: false },
      { slotId: 'P004-04', paragraphOrder: 4, stepName: '正确认知', materialTypes: ['case', 'fixed_phrase', 'golden_sentence'], isPrimary: true, isOptional: false },
      { slotId: 'P004-05', paragraphOrder: 5, stepName: '数据支撑', materialTypes: ['golden_sentence', 'data'], isPrimary: true, isOptional: false },
      ...
      { slotId: 'P004-07', paragraphOrder: 7, stepName: '金句收尾', materialTypes: ['personal_fragment', 'golden_sentence'], isPrimary: true, isOptional: false },
    ],
    emotionCurve: [
  ...
  // ============================================================
  {
    ...
    materialPositionMap: [
      { slotId: 'P005-01', paragraphOrder: 1, stepName: '热点引入', materialTypes: ['misconception', 'case', 'personal_fragment'], isPrimary: true, isOptional: false },
      { slotId: 'P005-02', paragraphOrder: 2, stepName: '事件分析', materialTypes: ['analogy', 'data'], isPrimary: true, isOptional: false },
      { slotId: 'P005-03', paragraphOrder: 3, stepName: '保险关联', materialTypes: ['data', 'analogy', 'fixed_phrase'], isPrimary: true, isOptional: false },
      { slotId: 'P005-04', paragraphOrder: 4, stepName: '正确应对', materialTypes: ['case', 'fixed_phrase', 'golden_sentence'], isPrimary: true, isOptional: false },
      { slotId: 'P005-05', paragraphOrder: 5, stepName: '数据支撑', materialTypes: ['golden_sentence', 'data'], isPrimary: true, isOptional: false },
      ...
      { slotId: 'P005-07', paragraphOrder: 7, stepName: '金句收尾', materialTypes: ['personal_fragment', 'golden_sentence'], isPrimary: true, isOptional: false },
    ],
    emotionCurve: [
  ...
  // ============================================================
  {
    ...
    materialPositionMap: [
      { slotId: 'P006-01', paragraphOrder: 1, stepName: '产品亮点', materialTypes: ['misconception', 'case', 'personal_fragment'], isPrimary: true, isOptional: false },
      { slotId: 'P006-02', paragraphOrder: 2, stepName: '深度解析', materialTypes: ['analogy', 'data'], isPrimary: true, isOptional: false },
      { slotId: 'P006-03', paragraphOrder: 3, stepName: '常见问题', materialTypes: ['data', 'case'], isPrimary: true, isOptional: false },
      { slotId: 'P006-04', paragraphOrder: 4, stepName: '横向对比', materialTypes: ['case', 'misconception', 'fixed_phrase'], isPrimary: true, isOptional: false },
      { slotId: 'P006-05', paragraphOrder: 5, stepName: '数据支撑', materialTypes: ['golden_sentence'], isPrimary: true, isOptional: false },
      ...
      { slotId: 'P006-07', paragraphOrder: 7, stepName: '金句收尾', materialTypes: ['personal_fragment', 'golden_sentence'], isPrimary: true, isOptional: false },
    ],
    emotionCurve: [
  ...
  // ============================================================
  {
    ...
    materialPositionMap: [
      { slotId: 'P007-01', paragraphOrder: 1, stepName: '经历引入', materialTypes: ['misconception', 'case', 'personal_fragment'], isPrimary: true, isOptional: false },
      { slotId: 'P007-02', paragraphOrder: 2, stepName: '心路历程', materialTypes: ['analogy', 'personal_fragment', 'fixed_phrase'], isPrimary: true, isOptional: false },
      { slotId: 'P007-03', paragraphOrder: 3, stepName: '转折点', materialTypes: ['data', 'case'], isPrimary: true, isOptional: false },
      { slotId: 'P007-04', paragraphOrder: 4, stepName: '感悟总结', materialTypes: ['case', 'misconception', 'fixed_phrase'], isPrimary: true, isOptional: false },
      { slotId: 'P007-05', paragraphOrder: 5, stepName: '数据支撑', materialTypes: ['golden_sentence', 'data'], isPrimary: true, isOptional: false },
      ...
      { slotId: 'P007-07', paragraphOrder: 7, stepName: '金句收尾', materialTypes: ['personal_fragment', 'golden_sentence'], isPrimary: true, isOptional: false },
    ],
    emotionCurve: [
  ...
  // ============================================================
  {
    ...
    materialPositionMap: [
      { slotId: 'P008-01', paragraphOrder: 1, stepName: '坑点引入', materialTypes: ['misconception', 'case', 'personal_fragment'], isPrimary: true, isOptional: false },
      { slotId: 'P008-02', paragraphOrder: 2, stepName: '错误认知', materialTypes: ['analogy', 'misconception', 'data'], isPrimary: true, isOptional: false },
      { slotId: 'P008-03', paragraphOrder: 3, stepName: '坑点案例', materialTypes: ['data', 'case'], isPrimary: true, isOptional: false },
      { slotId: 'P008-04', paragraphOrder: 4, stepName: '避坑方法', materialTypes: ['case', 'misconception', 'fixed_phrase'], isPrimary: true, isOptional: false },
      { slotId: 'P008-05', paragraphOrder: 5, stepName: '数据支撑', materialTypes: ['golden_sentence', 'data'], isPrimary: true, isOptional: false },
      ...
      { slotId: 'P008-07', paragraphOrder: 7, stepName: '金句收尾', materialTypes: ['personal_fragment', 'golden_sentence'], isPrimary: true, isOptional: false },
    ],
    emotionCurve: [
  ...
  // ============================================================
  {
    ...
    materialPositionMap: [
      { slotId: 'P009-01', paragraphOrder: 1, stepName: '对比引入', materialTypes: ['misconception', 'case', 'personal_fragment'], isPrimary: true, isOptional: false },
      { slotId: 'P009-02', paragraphOrder: 2, stepName: 'A方案解析', materialTypes: ['analogy', 'data', 'fixed_phrase'], isPrimary: true, isOptional: false },
      { slotId: 'P009-03', paragraphOrder: 3, stepName: 'B方案解析', materialTypes: ['data', 'analogy', 'fixed_phrase'], isPrimary: true, isOptional: false },
      { slotId: 'P009-04', paragraphOrder: 4, stepName: '核心差异', materialTypes: ['case', 'misconception', 'golden_sentence'], isPrimary: true, isOptional: false },
      { slotId: 'P009-05', paragraphOrder: 5, stepName: '选择建议', materialTypes: ['golden_sentence', 'data'], isPrimary: true, isOptional: false },
      { slotId: 'P009-06', paragraphOrder: 6, stepName: '案例佐证', materialTypes: ['fixed_phrase', 'personal_fragment'], isPrimary: true, isOptional: false },
      { slotId: 'P009-07', paragraphOrder: 7, stepName: '金句收尾', materialTypes: ['personal_fragment', 'golden_sentence'], isPrimary: true, isOptional: false },
    ],
    emotionCurve: [
  ...
  // ============================================================
  {
    ...
    materialPositionMap: [
      { slotId: 'P010-01', paragraphOrder: 1, stepName: '年度回顾引入', materialTypes: ['misconception', 'case', 'personal_fragment'], isPrimary: true, isOptional: false },
      { slotId: 'P010-02', paragraphOrder: 2, stepName: '重大事件', materialTypes: ['analogy', 'data', 'case'], isPrimary: true, isOptional: false },
      { slotId: 'P010-03', paragraphOrder: 3, stepName: '数据盘点', materialTypes: ['data', 'misconception'], isPrimary: true, isOptional: false },
      { slotId: 'P010-04', paragraphOrder: 4, stepName: '趋势预判', materialTypes: ['case', 'fixed_phrase', 'golden_sentence'], isPrimary: true, isOptional: false },
      { slotId: 'P010-05', paragraphOrder: 5, stepName: '个人思考', materialTypes: ['golden_sentence', 'analogy'], isPrimary: true, isOptional: false },
      ...
      { slotId: 'P010-07', paragraphOrder: 7, stepName: '金句收尾', materialTypes: ['personal_fragment', 'golden_sentence'], isPrimary: true, isOptional: false },
    ],
    emotionCurve: [
