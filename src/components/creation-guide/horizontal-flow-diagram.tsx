...
export function HorizontalFlowDiagram({
  ...
  return (
    <div className="bg-slate-50/80 backdrop-blur-sm rounded-2xl border border-slate-200/60 p-5 shadow-sm">
      ...
      {/* 横向流程图节点 */}
      <div className="relative">
        <div className="flex items-center justify-start md:justify-center py-5 overflow-x-auto pl-12 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-transparent">
